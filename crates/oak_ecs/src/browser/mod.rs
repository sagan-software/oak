use crate::markup::{Attribute, Node, NodeParent};
use crate::specs_hierarchy::Parent;
use hibitset::BitSet;
use specs::prelude::{
    Component, ComponentEvent, Entities, Join, Read, ReadStorage, ReaderId, Resources, System,
    SystemData, VecStorage, WriteStorage,
};
