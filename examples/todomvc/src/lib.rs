...
use web_sys::{console, Document, Event, EventTarget, HtmlInputElement, InputEvent, MouseEvent, Node};
...
pub fn main() {
    ...
    let container = oak::markup::create_element(
        &mut world, "div", &[("class", "todomvc-wrapper")],
    )
        .with(oak::markup::VirtualNodeParent(body_entity))
        .build();
    let section = oak::markup::create_element(
        &mut world, "section", &[("class", "todoapp")],
    )
        .with(oak::markup::VirtualNodeParent(container))
        .build();
    let header = oak::markup::create_element(
        &mut world, "header", &[("class", "header")],
    )
        .with(oak::markup::VirtualNodeParent(section))
        .build();
    let h1 = oak::markup::create_element(
        &mut world, "h1", &[],
    )
    ...
    oak::markup::create_text(&mut world, "todos")
        ...
        .build();
    oak::markup::create_element(&mut world, "input", &[
        ("class", "new-todo"),
    ...
    let footer = oak::markup::create_element(
        &mut world, "footer", &[("class", "info")],
    )
        .with(oak::markup::VirtualNodeParent(container))
        .build();
    let footer_p1 = oak::markup::create_element(
        &mut world, "p", &[],
    )
    ...
    oak::markup::create_text(&mut world, "Double-click to edit a todo")
        ...
        .build();
    let footer_p2 = oak::markup::create_element(
        &mut world, "p", &[],
    )
        .with(oak::markup::VirtualNodeParent(footer))
        .build();
    oak::markup::create_text(&mut world, "Written by ")
        ...
        .build();
    let a = oak::markup::create_element(
        &mut world, "a", &[("href", "http://sagan.software")],
    )
        .with(oak::markup::VirtualNodeParent(footer_p2))
        .build();
    oak::markup::create_text(&mut world, "sagan.software")
        ...
        .build();
    let footer_p3 = oak::markup::create_element(
        &mut world, "p", &[],
    )
        .with(oak::markup::VirtualNodeParent(footer))
        .build();
    oak::markup::create_text(&mut world, "Part of ")
        ...
        .build();
    let a2 = oak::markup::create_element(
        &mut world, "a", &[("href", "http://todomvc.com")],
    )
        .with(oak::markup::VirtualNodeParent(footer_p3))
        .build();
