...
use crate::vdom::{Children as VirtualChildren, Element as VirtualElement, Node as VirtualNode};
...
fn apply_text_patch<Msg: 'static>(
    ...
    match patch {
        ...
        _ => unreachable!("Text nodes should only receive ChangeText or Replace patches, not ..."),
    };
